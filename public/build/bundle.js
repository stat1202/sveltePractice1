...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$5, 21, 4, 437);
    			attr_dev(header, "class", "svelte-tjhnq9");
    			add_location(header, file$5, 20, 0, 423);
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*mode*/ ctx[3]) + " svelte-tdg9qs"));
    			attr_dev(button, "type", /*type*/ ctx[0]);
    			add_location(button, file$4, 86, 0, 1695);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*mode*/ 8 && button_class_value !== (button_class_value = "" + (null_to_empty(/*mode*/ ctx[3]) + " svelte-tdg9qs"))) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$4, 84, 0, 1654);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 66, 8, 1027);
    			attr_dev(h2, "class", "svelte-k141lj");
    			add_location(h2, file$3, 67, 8, 1053);
    			attr_dev(p0, "class", "svelte-k141lj");
    			add_location(p0, file$3, 68, 8, 1082);
    			attr_dev(header, "class", "svelte-k141lj");
    			add_location(header, file$3, 65, 4, 1009);
    			...
    			add_location(img, file$3, 71, 8, 1148);
    			attr_dev(div0, "class", "image svelte-k141lj");
    			add_location(div0, file$3, 70, 4, 1119);
    			attr_dev(p1, "class", "svelte-k141lj");
    			add_location(p1, file$3, 74, 8, 1235);
    			attr_dev(div1, "class", "content svelte-k141lj");
    			add_location(div1, file$3, 73, 4, 1204);
    			attr_dev(footer, "class", "svelte-k141lj");
    			add_location(footer, file$3, 76, 4, 1273);
    			attr_dev(article, "class", "svelte-k141lj");
    			add_location(article, file$3, 64, 0, 994);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$2, 22, 0, 372);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 48, 8, 1019);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$1, 46, 8, 928);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label_1, file$1, 44, 4, 843);
    			attr_dev(div, "class", "form-control svelte-tu2tjv");
    			add_location(div, file$1, 43, 0, 811);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [controlType, id, label, rows, value, type, input_handler];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(form, "class", "svelte-1ndcdzo");
    			add_location(form, file, 59, 4, 1652);
    			attr_dev(main, "class", "svelte-1ndcdzo");
    			add_location(main, file, 58, 0, 1641);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let title, subtitle, address, email, description, imageURL = "";
